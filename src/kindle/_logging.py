...
class KindleLogHelper:
    def set_level(self, level: Union[str, int]) -> None:
        """Set logging level for the kindle package."""
    ...
    def set_console_logger(self,
        ...
        """Set up a console logger to the kindle package."""
    ...
    def set_file_logger(
        ...
        """Set up a file logger to the kindle package."""
